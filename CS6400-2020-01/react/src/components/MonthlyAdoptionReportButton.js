...
class MonthlyAdoptionReportButton extends Component {
    constructor(props){
    ...
    this.state = {};
        ...
        renderRedirectMonthlyAdoptionReport = () => {
            if (this.state.redirect) {
                return <Redirect to ='/MonthlyAdoptionReport' />
            }
        }
    ...
    render() {
        ...
        return (
                    ...
                    <>
                        ...
                        {this.renderRedirectMonthlyAdoptionReport()}
...
export default MonthlyAdoptionReportButton;
