...
class AdoptionAppReview extends Component {
    constructor(props){
    ...
    this.state = {
       ...
       // }
        ...
        componentDidMount(){
            ...
            //axios.get('http://app-server:8080/adoption' )
                .then(res => {
    ...
    handleSubmit = event => {
            ...
            //     })
                axios.post('http://localhost:8080/applicantInformationWithEmail', {adoption_record})
                    .then(res => {
                        console.log(res)
                        console.log(res.data);
    ...
    render() {
        ...
        return (
            ...
            <div>
                    ...
                    editable={{
                        ...
                        new Promise((resolve, reject) => {
                            setTimeout(() => {
                            {
                                ...
                                data[index] = newData;
                                // axios.post("http://localhost:8080/applicantInformationWithEmail",
                                //           newData
                                //           ).then(res => console.log(res.data));
                                // console.log({data});
                                // this.setState({ data }, () => resolve());
                                fetch("http://localhost:8080/applicantInformationWithEmail", {
                                                      method: "POST",
                                                      headers: {
              ...
              <button type="submit" class="block" style = {{width: 100},{height:40}}>Submit</button>
...
export default AdoptionAppReview;
