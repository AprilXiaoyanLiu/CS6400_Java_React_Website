...
class VolunteerLookupButton extends Component {
    constructor(props){
    ...
    this.state = {};
        ...
        renderRedirectVolunteerLookup = () => {
            if (this.state.redirect) {
                return <Redirect to ='/VolunteerLookup' />
            }
        }
    ...
    render() {
        ...
        return (
                    ...
                    <>
                        ...
                        {this.renderRedirectVolunteerLookup()}
...
export default VolunteerLookupButton;
