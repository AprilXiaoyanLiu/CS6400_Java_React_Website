...
class VolunteerMonthButton extends Component {
    constructor(props){
    ...
    this.state = {};
        ...
        renderRedirectVolunteerOfMonth = () => {
            if (this.state.redirect) {
                return <Redirect to ='/VolunteerOfMonth' />
            }
        }
    ...
    render() {
        ...
        return (
                    ...
                    <>
                        ...
                        {this.renderRedirectVolunteerOfMonth()}
...
export default VolunteerMonthButton;
